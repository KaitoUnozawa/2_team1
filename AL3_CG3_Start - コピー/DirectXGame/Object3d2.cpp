...
XMFLOAT3 Object3d2::eye = { 0, 0, -100.0f };
...
std::vector<Object3d2::VertexPosNormalUv> Object3d2::vertices;
std::vector<unsigned short> Object3d2::indices;
Object3d2::Material Object3d2::material;
...
bool Object3d2::LoadTexture(const std::string& directoryPath, const std::string& filename)
{
	HRESULT result = S_FALSE;
...
void Object3d2::LoadMaterial(const std::string& directoryPath, const std::string& filename)
{
	std::ifstream file;
